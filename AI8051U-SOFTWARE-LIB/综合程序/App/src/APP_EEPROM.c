...
通过串口2(P4.2 P4.3)对芯片内部自带的EEPROM(FLASH)空间进行读写测试。
...
//    COMx_InitStructure.UART_BRT_Use   = BRT_Timer2;   //选择波特率发生器, BRT_Timer2 (注意: 串口2固定使用BRT_Timer2, 所以不用选择)
    ...
    PrintString2("AI8051U系列单片机EEPROM测试程序，串口命令设置如下:\r\n");    //UART2发送一个字符串
    PrintString2("E 0x000040             --> 对0x000040地址扇区内容进行擦除\xfd.\r\n"); //UART2发送一个字符串
