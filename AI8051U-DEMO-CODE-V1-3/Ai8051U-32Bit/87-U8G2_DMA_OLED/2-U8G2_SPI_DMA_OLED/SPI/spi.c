...
//#endif
    ...
    //主频35M，PLL=35M/4*12/4=103.2MHz/4=26.25MHz
    HSCLKDIV = 4;               //HSPWM/HSSPI时钟源2分频
    
    SPCTL = 0xd3;               //设置SPI为主机模式,速度为SPI时钟/2(26.25M/2=13.13M)
    HSSPI_CFG2 |= 0x60;         //交换MOSI与MISO脚, 使能SPI高速模式
