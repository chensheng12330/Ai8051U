...
void DMA_LCM_init(void)
{
    ...
    //----------------------------------------------
    P0_MODE_OUT_PP(GPIO_Pin_5);     //P0.5 设置成推挽输出
    P2_MODE_IO_PU(GPIO_Pin_All);    //P2 设置成准双向口
    P3_MODE_OUT_PP(GPIO_Pin_2 | GPIO_Pin_4 | GPIO_Pin_6 | GPIO_Pin_7);    //P3.2,P3.4,P3.6,P3.7口设置成推挽输出
    P4_MODE_OUT_PP(GPIO_Pin_5 | GPIO_Pin_7);    //P4.5,P4.7 设置成推挽输出
    P5_MODE_OUT_PP(GPIO_Pin_3);     //P5.3 设置成推挽输出
    
    LCM_CTRL_SW(LCM_CTRL_P45_P37_P36);
    LCM_DATA_SW(LCM_D8_NA_P2);
